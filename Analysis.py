...
class getTweets:
    ...
    def process_tweets(self):
        ...
        plt.pause(0.5)
        read("Sentiments for 'Covid-19 Vaccine'")
        plt.close()
        ...
        plt.show(block=False)
        plt.pause(0.5)
        read("Subjectivity for 'Covid-19 Vaccine'")
        plt.close()
        ...
        plt.show(block=False)
        plt.pause(0.5)
        read("Word frequency in Vaccine Tweets")
        plt.close()
        ...
        #plt.show(block=False)
        #plt.pause(0.5)
        #read("Sentiment Analysis for Covid-19 Vaccines")
        #plt.close()
...
#TREATMENTS
        ...
        plt.show(block=False)
        plt.pause(0.5)
        read("Word frequency in Therapeutic Tweets")
        plt.close()
        ...
        plt.show(block=False)
        plt.pause(0.5)
        read("Sentiments for Therapeutics")
        plt.close()
        ...
        plt.show(block=False)
        plt.pause(0.5)
        read("Subjectivity for Therapeutics")
        plt.close()
...
if __name__ == "__main__":
    ...
    all_tweets_filename = 'TweetsBySearchTerm.csv'
    all_words_list = []
    gt = getTweets()
    gt.process_tweets()
